...
def PrepRoadsVA(inRCL):
 ...
 If any of the assumed fields do not exist, have been renamed, or are in the wrong format, the script will fail."""
   ...
   arcpy.AddMessage("Adding 'SPEED_cmt' field...")
   ...
   arcpy.AddMessage("Adding and populating 'FlgFld' field...")
   ...
   # This field is used to store speed values to be used in later processing. It allows for updating according to QC criteria, so that the existing, original "LOCAL_SPEED_MPH" field can remain unaltered. Initially, the "SPEED_upd" field is set to equal the existing "LOCAL_SPEED_MPH" field. It will be updated later if needed.
   arcpy.AddMessage("Adding and populating 'SPEED_upd' field...")
   ...
   arcpy.CalculateField_management(inRCL, "SPEED_upd", expression, codeblock)
   ...
   arcpy.AddMessage("Adding and populating 'TravTime' field...")
   ...
   arcpy.AddMessage("Adding and populating 'RmpHwy' field...")
